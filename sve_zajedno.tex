...
Iako kvalitetna veštačka inteligencija može da doprinese lakom osvajanju bitaka, to nije nužno pozitivna strana za manje razvijene države koje bi joj se potencijalno suprotstavljale. Ključan deo pozitivne strane pretstavlja koncept \textbf{etičkog oružija}. Etičko oružje je oružje koje je pametno programirano sa svim pravilima i zakonima ratovanja kao što su su pravila vođenja borbe i IHL. Ovakvi sistemi su zasnovani na tehnologijama maksimalno i minimalno pravične veštačke inteligencije (eng. \textit{maximally and minimally just artificial intelligence}), odnosno \textbf{MaxAI} i \textbf{MinAI}.
